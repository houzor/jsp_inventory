...
<nav class="main-nav">
    <ul>
        <li><a href="${pageContext.request.contextPath }/pages/userindex.jsp" id="shouye">首页</a></li>
        ...
        <li><a href="${pageContext.request.contextPath }/AttendServlet?method=exit">下班打卡&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;></a></li>
    </ul>
</nav>
<div class="content">
